    ...
    <>
      {toast && (
        <div className={`toast-message ${toast.tone}`} role="status">
          ...
          <button aria-label="알림 닫기" onClick={closeToast}>×</button>
        </div>
      )}
      {dialog && (
        <div className="modal-backdrop" role="presentation">
          <section className="confirm-modal" role="dialog" aria-modal="true" aria-labelledby="confirm-title">
            ...
            <div className="modal-actions">
              <button className="button button-ghost" onClick={closeDialog}>취소</button>
              <button className="button button-danger" onClick={() => { dialog.onConfirm(); closeDialog(); }}>
